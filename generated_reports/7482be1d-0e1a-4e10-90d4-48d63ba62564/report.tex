...
\fancypagestyle{mainchapter}{
  ...
  \fancyhead[L]{\small Embedded DSP Software Developer}
  \fancyhead[R]{\small\nouppercase{\leftmark}}
...
\vspace{8pt}
\includegraphics[height=5cm]{vtu_logo.png}\par
\vspace{8pt}
{\itshape An Internship Report\par}
\vspace{2pt}
{\itshape On\par}
\vspace{4pt}
{\LARGE \textbf{\textquotedblleft TriSpace Technologies\textquotedblright}\par}
\vspace{4pt}
{\textcolor{red}{jan 12 to apr 13}\par}
\vspace{8pt}
...
Submitted by\par
\vspace{4pt}
{\large \textbf{STUDENT NAME \hspace{2cm} 1VI22EC000}\par}
\vspace{10pt}
\includegraphics[height=4cm]{vit_logo.png}\par
\vspace{10pt}
...
\includegraphics[height=2.8cm]{dept_seal.png}\\[8pt]
...
\noindent
This is to certify that the internship entitled \textbf{“Embedded DSP Software Develope”} is a bonafide work carried out by \textbf{STUDENT NAME (1VI22EC000)} in partial fulfillment of the requirements for the award of Bachelor of Engineering degree in \textbf{Electronics and communication Engineering}, Visvesvaraya Technological University, Belagavi, during the academic year 2025-2026.
...
% ==========================================================================
\newpage
\setcounter{page}{3}  % Ack = page ii (certificate was empty)
\begin{center}
...
I would like to express my sincere gratitude to \textbf{Visvesvaraya Technological University (VTU)} for providing me with the opportunity to undertake this internship as a part of my academic curriculum. I extend my heartfelt thanks to the Principal of Vemana Institute of Technology, \textbf{Dr. Vijayasimha Reddy B G}, for his constant support and encouragement throughout my academic journey.


I am deeply thankful to the Head of the Department, \textbf{Dr. Suneeta}, for her valuable guidance and motivation. I would also like to express my sincere appreciation to my internal supervisor, \textbf{Prof. Suma B V}, for her continuous support, constructive feedback, and encouragement during the internship period.


I would like to extend my special thanks to my external supervisor, \textbf{Mr. N. Vijay Anand} from \textbf{TriSpace Technologies}, for providing me with the opportunity to work on real-time DSP systems and for guiding me throughout the internship. His technical insights and mentorship played a crucial role in enhancing my understanding of embedded systems and DSP programming.


I would also like to thank all the staff members at \textbf{TriSpace Technologies} for their support, knowledge sharing, and collaborative environment, which made my learning experience highly enriching.
...
\fancypagestyle{plain}{
  ...
  \renewcommand{\headrulewidth}{0.4pt}
  \renewcommand{\footrulewidth}{0.4pt}
  \fancyhead[L]{\small Embedded DSP Software Develope}
  \fancyhead[R]{\small\nouppercase{\leftmark}}
  \fancyfoot[L]{\small Dept. of ECE, Vemana IT}
  \fancyfoot[C]{\small 2025-2026}
  \fancyfoot[R]{\small Page \thepage\ of \pageref{LastPage}}
...
\section{Relevance of Embedded DSP Software Developer to Electronics and communication Engineering}

The role of Software Developer in DSP and embedded systems is highly relevant to Electronics and Communication Engineering (ECE), as it directly aligns with core subjects and practical applications studied during the course.
...
This chapter provides an overview of TriSpace Technologies, the organization where I completed my internship as a Embedded DSP Software Developer. Understanding the organization is essential to gain context about the work environment, technological focus, and industry relevance of the internship.
...
\begin{figure}[H]
\centering
\includegraphics[width=0.55\textwidth,height=5cm,keepaspectratio]{trispace.png}
...
This chapter presents a detailed description of the work carried out during my internship at TriSpace Technologies in the role of a Embedded DSP Software Developer. The internship followed a structured progression, starting from fundamental programming concepts and gradually advancing towards complex DSP algorithm implementation and optimization.
...
\begin{figure}[H]
\centering
\includegraphics[width=0.55\textwidth,height=5cm,keepaspectratio]{chapter 3 image.jpeg}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.55\textwidth,height=5cm,keepaspectratio]{chapter 3.1 image.jpeg}
...
\begin{figure}[H]
\centering
\includegraphics[width=1.00\textwidth,height=11cm,keepaspectratio]{chapter 4 image.jpeg}
